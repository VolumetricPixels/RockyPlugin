...
public class SpoutShapelessRecipe implements Recipe {
	 ...
	 */
	public SpoutShapelessRecipe addIngredient(int ingredient) {
	 ...
	 * @return The changed recipe, so you can chain calls.
	 */
	public SpoutShapelessRecipe addIngredient(int count, int ingredient) {
	 ...
	 */
	public SpoutShapelessRecipe removeIngredient(int ingredient) {
