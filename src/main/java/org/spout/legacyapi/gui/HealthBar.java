...
public class HealthBar extends GenericWidget {
	...
	/**
	 * Gets the number of pixels each heart is offset when drawing the next
	 * heart.
	 * 
	 * @return pixel offset
	 */
	...
	/**
	 * Sets the number of pixels each heart is offset when drawing the next
	 * heart.
	 * 
	 * @param offset
	 *            when drawing hearts
	...
	/**
	 * Gets the percent of health a player needs to fall to or below in order
	 * for the hearts to begin blinking.
	 * <p/>
	...
	/**
	 * Sets the percent of health a player needs to fall to or below in order
	 * for the hearts to begin blinking.
	 * <p/>
	 * Valid percents are between zero and one hundred, inclusive.
	 * 
