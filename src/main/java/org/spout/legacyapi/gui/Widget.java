...
public interface Widget {
	 ...
	 * 
	 * @param dirty
	 *            if it should be automatic (default: true)
	 * @return widget
	 */
	 ...
	 * @param value
	 *            a custom value used by some types (default: 1)
	 * @param count
	 *            how many frames
	 * @param ticks
	 ...
	 *            should the animation be repeated
	 * @param reset
	 *            should it reset back to the first frame after finishing
	 * @return widget
	 */
	public Widget animate(WidgetAnim type, float value, short count, short ticks,
			boolean repeat, boolean reset);
	 ...
	 * 
	 * @param finish
	 *            should it finish the current loop (if repeating)
	 * @return widget
	 */
