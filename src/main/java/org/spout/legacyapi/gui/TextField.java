...
import org.spout.legacyapi.event.screen.TextFieldChangeEvent;
...
public interface TextField extends Control {
	/**
	 * Gets the position of the cursor in the text field. Position zero is the
	 * start of the text.
	 * 
	 * @return position
	 */
	...
	/**
	 * Sets the maximum lines this text field can hold. If zero is passed, the
	 * text field will hold as many lines as it can depending on its size.
	 * 
	 * @param max
	 *            lines (0 – 127)
	 * @return textfield
	...
	/**
	 * Sets the tab index for this text field. When the player presses the
	 * tabulator key the text field with index+1 will obtain the focus. Text
	 * fields using the same index may not obtain focus when pressing the
	 * tabulator key. The behaviour discontinuous index sequences is undefined.
	 * 
	 * @param index
	 *            Tab index (0 – 127)
	 * @return textfield
	...
	/**
	 * Sets whether this text field shall obtain focus. Make sure only one text
	 * field gets the focus at a time.
	 * 
	 * @param focus
	 * @return textfield
	 */
	...
	/**
	 * Fires when this text field is typed into on the screen. This event will
	 * also be sent to the screen listener.
	 * 
	 * @param event
	 */
	...
	/**
	 * Sets the placeholder to text. The placeholder will be displayed when no
	 * text is in the TextField
	 * 
	 * @param text
	 *            to set as placeholder
	 * @return textfield
	 */
