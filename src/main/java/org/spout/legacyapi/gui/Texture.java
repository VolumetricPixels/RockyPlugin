...
public interface Texture extends Widget {
	...
	/**
	 * Sets the url of this texture to render All textures must be of png or jpg
	 * type and a size that is a factor of 2 (e.g 64x128). Use the alpha channel
	...
	/**
	 * Sets if the texture should draw the full alpha channel instead of just
	 * using a bit-mask.
	 * 
	 * @param draw
	 ...
	 * than -1 will draw a 1:1 slice of the texture rather than scaling it to
	 * fit the width and height.
	 * 
	 * @param top
	 *            the top offset
	 * @return texture
	...
	/**
	 * Set the offset to the left of the image. Setting this to a anything other
	 * than -1 will draw a 1:1 slice of the texture rather than scaling it to
	 * fit the width and height.
	 * 
	 * @param left
