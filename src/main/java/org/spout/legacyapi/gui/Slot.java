...
public interface Slot extends Control {
	 ...
	 * 
	 * @param item
	 *            the stack that the user wants to put in. The amount property
	 *            in the stack will be calculated correctly, for example when
	 *            the user right-clicks on the slot, it will only give one item.
	 ...
	 * 
	 * @param item
	 *            the stack that the user will get. The amount property in the
	 *            stack will be calculated correctly,for example when the user
	 *            right-clicks on the slot, it would split the amount.
	 * @return false if you want to cancel that.
	 */
	public boolean onItemTake(ItemStack item);

	/**
	 * Called when the user shift-clicks on the slot. If the user holds shift
	 * while left-clicking, no other actions will be done.
	 */
	public void onItemShiftClicked();

	/**
	 * Called when the user wants to exchange the item on his cursor with that
	 * in the slot.
	 * 
	 * @param current
	 *            the item that is currently in the slot
	 * @param cursor
	 *            the item that is on the cursor
