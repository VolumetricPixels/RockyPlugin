...
public class PacketMovementAddon implements Packet {
	...
	public void writeData(PacketOutputStream output) throws IOException {
		output.writeDouble(player.getGravityMultiplier());
		output.writeDouble(player.getWalkingMultiplier());
		output.writeDouble(player.getSwimmingMultiplier());
		output.writeDouble(player.getJumpingMultiplier());
		output.writeDouble(player.getAirSpeedMultiplier());
	}
