...
* 
*/
public class PacketStopMusic implements Packet {
	 ...
	 * @param fadeOutTick
	 */
	public PacketStopMusic(boolean isResetOnly, int fadeOutTick) {
	...
	public void writeData(PacketOutputStream output) throws IOException {
		output.writeBoolean(isResetOnly);
		output.writeShort(fadeOutTick);
	}
