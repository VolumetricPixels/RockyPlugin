...
public interface Screen extends Widget {
	/**
	 * Get's an array of all the attached widgets to this screen. Modifying this
	 * array will not affect the screen.
	 * 
	...
	/**
	 * Is true if the screen has the given widget attached to it. Uses a linear
	 * search, takes O(n) time to complete.
	 * 
	 * @param widget
	 *            to search for
	...
	/**
	 * Is true if the screen has a widget with the given id attached to it. Uses
	 * a linear search, takes O(n) time to complete.
	 * 
	 * @param id
	 *            to search for
	 * @return true if the widget was found
	...
	/**
	 * Get's the widget that is associated with the given id, or null if none
	 * was found
	 * 
	 * @param id
	 *            to search for
	...
	/**
	 * Replaces any attached widget with the given widget's id with the new
	 * widget
	 * 
	 * @param widget
	 *            to replace with
	...
	/**
	 * Sets the visibility of the grey background. If true, it will render
	 * normally. If false, it will not appear on the screen.
	 * 
	 * @param enable
	 *            the visibility
	 * @return the screen
