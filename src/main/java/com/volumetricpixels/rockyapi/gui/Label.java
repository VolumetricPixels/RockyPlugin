 ...
 * <p/>
 * Normally the text will overflow the widget "box" if it is smaller than the
 * text itself, however you can force the minimum size of the widget to the size
 * of the text content with the setAuto method, and use the setFixed method to
 * stop it resizing if inside a Container.
 */
