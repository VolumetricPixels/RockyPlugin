 ...
 * solid block of colour, and can set the alpha-level of the Color in order to
 * make it translucent.
 */
public interface Gradient extends Widget {
	...
	/**
	 * Set the direction the gradient is drawn. Default is VERTICAL, if using
	 * HORIZONTAL then read top as left and bottom as right.
	 * 
	 * @param axis
	 *            the orientation to draw in
	 * @return
	 */
	public Gradient setOrientation(Orientation axis);

	/**
	 * Get the direction the gradient is drawn. Default is VERTICAL, if using
	 * HORIZONTAL then read top as left and bottom as right.
	 * 
