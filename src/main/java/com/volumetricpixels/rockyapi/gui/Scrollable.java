...
public interface Scrollable extends Control {
	 ...
	 * 
	 * @param axis
	 *            of the scroll vector
	 * @return the position of the viewport on given axis
	 */
	public int getScrollPosition(Orientation axis);

	/**
	 * Sets the scroll position on the axis, in pixels. The allowed scroll
	 * amount ranges from 0 to getMaximumScrollPosition for given axis.
	 * 
	 * @param axis
	 *            the axis to scroll
	 * @param position
	...
	/**
	 * Adjusts the scroll position so that the given rectangle will fit into the
	 * viewport. If the given rect is too big, it will scroll to the x or y
	 ...
	 * 
	 * @param axis
	 * @return the maximum scroll position. Use the return value to scroll to
	 *         the very bottom.
	 * @returns 0 if no scrolling is possible, that means the whole content
	 *          would fit into the viewport.
	 */
	public int getMaximumScrollPosition(Orientation axis);

	/**
	 * Depending on the set ScrollBarPolicy, returns wether to show or not to
	 * show a scrollbar on the given axis
	 * 
	 * @param axis
	 *            to check if it should view a scrollbar
	...
	/**
	 * Gets the size of the rectangle inside the scrollable. This is usually
	 * getWidth/Height() - 16 when the corresponding scrollbar is visible.
	 * 
	 * @param axis
	 * @return
	 */
