...
public interface InGameHUD extends Screen {
	/**
	 * Is true if the widget can be attached to the screen. Primary controls,
	 * like the health bar can not be attached twice. Control widgets that
	 * require input from the mouse or keyboard can not be attached
	 * 
	 * @param widget
	 ...
	 * @param screen
	 *            to pop up
	 * @return true if the popup screen was attached, false if there was already
	 *         a popup launched
	 */
	...
	/**
	 * Ease of use method setting all the survival mode HUD elements to
	 * setVisible(toggle);
	 * 
	 * @param toggle
	 *            true or false
