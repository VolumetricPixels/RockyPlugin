...
public interface ListWidget extends Scrollable {
	 ...
	 * 
	 * @param n
	 *            the number of the item or -1 to clear the selection
	 * @return instance of the ListWidget
	 */
	 ...
	 * 
	 * @param item
	 *            the number of the item that was clicked/selected by keypress.
	 *            Can be -1 that means that no item is selected
	 * @param doubleClick
	 *            if true, item has been doubleclicked.
	 */
