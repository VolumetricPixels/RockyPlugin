...
public class KeyBinding {
	 ...
	 * @param delegate
	 */
	public KeyBinding(String id, Keyboard defaultkey, String description,
			Plugin plugin, BindingExecutionDelegate delegate) {
		this.id = id;
	...
	/**
	 * Gets the description that will be shown to players about the purpose of
	 * this keybinding
	 * 
	 * @return description
	 */
