...
public final class RockyMaterialManager implements MaterialManager {
	...
	public void addMaterial(Material material) {
		...
		if (material instanceof Item) {
			...
			try {
				net.minecraft.server.v1_5_R3.Item.byId[material.getId()] = (net.minecraft.server.v1_5_R3.Item) referenceClazz
		...
		try {
			net.minecraft.server.v1_5_R3.Block.byId[material.getId()] = (net.minecraft.server.v1_5_R3.Block) referenceClazz
	...
	public void deleteMaterial(Material material) {
		...
		if (material instanceof Item) {
			...
			net.minecraft.server.v1_5_R3.Item.byId[material.getId()] = null;
			return;
		}
		blockList.remove(material.getId());
		net.minecraft.server.v1_5_R3.Block.byId[material.getId()] = null;
	...
	public void clear() {
		for (int itemId : itemList.keySet()) {
			net.minecraft.server.v1_5_R3.Item.byId[itemId] = null;
		}
		for (int blockId : blockList.keySet()) {
			net.minecraft.server.v1_5_R3.Block.byId[blockId] = null;
		}
		itemList.clear();
		blockList.clear();
	}
